    ...
    if args.use_rl_loss:
        try:
            ...
            if mpu.get_data_parallel_rank() == 0:
                # Access the underlying model through the .module attribute of the DDP wrapper.
                first_router_grad = model[0].module.language_model.encoder.layers[0].mlp.router.weight.grad
